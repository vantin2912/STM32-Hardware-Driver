...
#else
#define INA219_I2C_Handle	I2C_HandleTypeDef

#define	INA219_Mem_Read 	HAL_I2C_Mem_Read
#define INA219_Mem_Write	HAL_I2C_Mem_Write
#define INA219_DeviceReady	HAL_I2C_IsDeviceReady

#endif


#define INA219_ADDRESS_Default					(0x40)
#define INA219_ADDRESS_A0	 					(0x41)
#define INA219_ADDRESS_A1						(0x44)
#define INA219_ADDRESS_A0A1						(0x45)
//
//	Registers
//
...
void INA219_setCalibration_Custom(INA219_t *ina219, float MaxExpectCurrent, float Rshunt);
