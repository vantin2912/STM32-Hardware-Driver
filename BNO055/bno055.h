...
#else
#define BNO055_printf	printf
#define BNO055_Delay	HAL_Delay
#define BNO055_I2CHandler 	I2C_HandleTypeDef
#endif
...
typedef struct{
	uint8_t Address;
	BNO055_I2CHandler* i2c;

}BNO055_HandlerStruct;
...
void BNO055_enableExternalCrystal(BNO055_HandlerStruct* bno055);
void BNO055_disableExternalCrystal(BNO055_HandlerStruct* bno055);
